...
public interface IErlElement extends IAdaptable, IDisposable {
	...
	enum Kind {
		// @formatter:off
		PROBLEM, MODEL, PROJECT, MODULE, ATTRIBUTE, FUNCTION, CLAUSE, EXPORT, IMPORT, EXPORTFUNCTION, HEADERCOMMENT, COMMENT, RECORD_DEF, MACRO_DEF, FOLDER, TYPESPEC, EXTERNAL, RECORD_FIELD
		// @formatter:on
	}
